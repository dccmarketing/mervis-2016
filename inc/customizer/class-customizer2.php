...
class Class_Names_Customizer {
	...
	public function register_panels( $wp_customize ) {
		...
		$panel['description'] 		= esc_html__( 'Options for Replace with Theme Name', 'mervis-2016' );
		$panel['priority'] 			= 10;
		$panel['theme_supports'] 	= '';
		$panel['title'] 			= esc_html__( 'Theme Options', 'mervis-2016' );
	...
	public function register_sections( $wp_customize ) {
		...
		$section['description'] = esc_html__( 'New Customizer Section', 'mervis-2016' );
		$section['panel'] 		= 'theme_options';
		$section['priority'] 	= 10;
		$section['title'] 		= esc_html__( 'New Section', 'mervis-2016' );
	...
	public function register_fields( $wp_customize ) {
		...
		$control['description'] = esc_html__( 'Paste in the Google Tag Manager code here. Do not include the comment tags!', 'mervis-2016' );
		$control['label'] 		= esc_html__( 'Google Tag Manager', 'mervis-2016' );
		$control['priority'] 	= 90;
		...
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Text Field', 'mervis-2016' );
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'URL Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Email Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Date Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Checkbox Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['sanitize_callback'] 	= '';
		$settings['transport'] 			= 'postMessage';
		$choices['choice1'] 			= esc_html__( 'Choice 1', 'mervis-2016' );
		$choices['choice2'] 			= esc_html__( 'Choice 2', 'mervis-2016' );
		$choices['choice3'] 			= esc_html__( 'Choice 3', 'mervis-2016' );
		$controls['choices'] 			= $choices;
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Multi-Checkbox Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Password Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$controls['choices'] 			= $choices;
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Radio Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$controls['choices'] 			= $choices;
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Select Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$setting['default'] 	= '';
		$setting['transport'] 	= 'postMessage';
		$control['description'] = esc_html__( '', 'mervis-2016' );
		$control['label'] 		= esc_html__( 'Textarea Manager', 'mervis-2016' );
		$control['priority'] 	= 10;
		...
		$controls['label'] 				= esc_html__( 'Range Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Select Page', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Color Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$controls 					= array();
		$controls['description'] 	= esc_html__( '', 'mervis-2016' );
		$controls['label'] 			= esc_html__( 'File Upload', 'mervis-2016' );
		$controls['priority'] 		= 10;
		$controls['section'] 		= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Image Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['transport'] 			= 'postMessage';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Media Field', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Select Country', 'mervis-2016' );
		...
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Select State', 'mervis-2016' );
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Layout', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Category', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Menu', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Post', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Post Type', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Tag', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose Taxonomy', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Choose User', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
		...
		$settings['default'] 			= '';
		$controls['description'] 		= esc_html__( '', 'mervis-2016' );
		$controls['label'] 				= esc_html__( 'Edit Content', 'mervis-2016' );
		$controls['priority'] 			= 10;
		$controls['section'] 			= 'new_section';
