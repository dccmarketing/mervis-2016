 ...
 */
function function_names_get_video_thumb( $embed_code ) {
...
} // function_names_get_video_thumb()

#
# Return the thumbnail src for Vimeo videos
# $video_id = the Vimeo video id
#
function function_names_get_vimeo_thumb( $videoid ) {
...
} // function_names_get_vimeo_thumb()
